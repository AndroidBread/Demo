...
public class AliyunLiveShiftPlayerView extends RelativeLayout {
    ...
    private String _URL = "http://qt1.alivecdn.com/timeline/testshift.m3u8?auth_key=1594730859-0-0-b71fd57c57a62a3c2b014f24ca2b9da3";
    ...
    private void setPlaySource() {
        if(mAliyunLiveTimeShift == null){
            mAliyunLiveTimeShift = new LiveShift();
        }
        long currentSeconds = System.currentTimeMillis() / 1000;

        mAliyunLiveTimeShift.setUrl(_URL);
