...
public class ControlView extends RelativeLayout {
    ...
    private void updatePlayStateBtn() {
        if (mPlayState == IPlayer.started) {
            mPlayStateImagView.setImageResource(com.aliyun.player.aliyunplayerbase.R.drawable.alivc_playstate_pause);
        } else {
            mPlayStateImagView.setImageResource(com.aliyun.player.aliyunplayerbase.R.drawable.alivc_playstate_play);
        }
    }
