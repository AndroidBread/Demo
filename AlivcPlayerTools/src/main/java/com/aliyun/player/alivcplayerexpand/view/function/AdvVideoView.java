...
public class AdvVideoView extends RelativeLayout implements View.OnClickListener {
    ...
    private void initAdvTipsView(){
        ...
        int paddingLeft = (int) getContext().getResources().getDimension(com.aliyun.svideo.common.R.dimen.alivc_common_padding_10);
        int paddingTop = (int) getContext().getResources().getDimension(com.aliyun.svideo.common.R.dimen.alivc_common_padding_2);
        int paddingRight = (int) getContext().getResources().getDimension(com.aliyun.svideo.common.R.dimen.alivc_common_padding_10);
        int paddingBottom = (int) getContext().getResources().getDimension(com.aliyun.svideo.common.R.dimen.alivc_common_padding_2);
        mAdvTipsTextView.setPadding(paddingLeft,paddingTop,paddingRight,paddingBottom);
        mAdvTipsTextView.setTextSize(14);
        mAdvTipsTextView.setTextColor(getResources().getColor(com.aliyun.svideo.common.R.color.alivc_common_bg_white));
    ...
    private void addSubViewByGravityRightTop(View view){
        ...
        params.topMargin = (int) getResources().getDimension(com.aliyun.svideo.common.R.dimen.alivc_common_margin_6);
        params.rightMargin = (int) getResources().getDimension(com.aliyun.svideo.common.R.dimen.alivc_common_margin_4);
        //添加到布局中
        addView(view, params);
    }
