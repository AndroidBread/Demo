...
public class ControlView extends RelativeLayout implements ViewAction, ITheme {
    ...
    private LinearLayout mScreenCenterPlay;
    ...
    private void findAllViews() {
        ...
        mScreenCenterPlay = findViewById(R.id.screen_center_play);
    ...
    private void setViewListener() {
        ...
        mIvCenter.setOnClickListener(v -> {
    ...
    private void updateScreenShotBtn() {
        if (mAliyunScreenMode == AliyunScreenMode.Small || mScreenLocked) {
    ...
    private void updateSeekBarTheme(Theme theme) {
        //获取不同主题的图片
        int progressDrawableResId = com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_bg_blue;
        int thumbResId = com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_thumb_blue;
        if (theme == Theme.Blue) {
            progressDrawableResId = (com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_bg_blue);
            thumbResId = (R.drawable.alivc_seekbar_thumb_blue);
        } else if (theme == Theme.Green) {
            progressDrawableResId = (com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_bg_green);
            thumbResId = (com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_thumb_green);
        } else if (theme == Theme.Orange) {
            progressDrawableResId = (com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_bg_orange);
            thumbResId = (com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_thumb_orange);
        } else if (theme == Theme.Red) {
            progressDrawableResId = (com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_bg_red);
            thumbResId = (com.aliyun.player.aliyunplayerbase.R.drawable.alivc_info_seekbar_thumb_red);
        }
    ...
    private void updateLargeInfoBar() {
        if (mAliyunScreenMode == AliyunScreenMode.Small) {
            ...
            mTrackLinearLayout.setVisibility(View.INVISIBLE);
            mScreenModeBtn.setVisibility(View.VISIBLE);
            if (GlobalPlayerConfig.IS_VIDEO) {
                setAdvVideoTotalDuration();
    ...
    private void setAdvVideoTotalDuration() {
        ...
        switch (mAdvPosition) {
            ...
            case ONLY_MIDDLE:
            case ONLY_END:
                mSmallDurationText.setText(String.format("/%s", TimeFormater.formatMs(mAdvDuration + mSourceDuration)));
                mLargeDurationText.setText(TimeFormater.formatMs(mAdvDuration + mSourceDuration));
                break;
            case START_END:
            case MIDDLE_END:
            case START_MIDDLE:
                mSmallDurationText.setText(String.format("/%s", TimeFormater.formatMs(mAdvDuration * 2 + mSourceDuration)));
                mLargeDurationText.setText(TimeFormater.formatMs(mAdvDuration * 2 + mSourceDuration));
                break;
            default:
                mSmallDurationText.setText(String.format("/%s", TimeFormater.formatMs(mAdvDuration * 3 + mSourceDuration)));
    ...
    private void updateScreenModeBtn() {
        if (mAliyunScreenMode == AliyunScreenMode.Full) {
            mScreenModeBtn.setImageResource(R.drawable.icon_video_exit_screen);
        } else {
            mScreenModeBtn.setImageResource(R.drawable.icon_video_full_screen);
        }
    }
    ...
    private void updatePlayStateBtn() {
        if (mPlayState == PlayState.NotPlaying) {
            mPlayStateBtn.setImageResource(R.drawable.icon_video_start);
            mScreenCenterPlay.setVisibility(VISIBLE);
        } else if (mPlayState == PlayState.Playing) {
            mPlayStateBtn.setImageResource(R.drawable.icon_video_pause);
            mScreenCenterPlay.setVisibility(GONE);
        }
    }
...
//        mHideHandler.sendEmptyMessageDelayed(WHAT_HIDE, DELAY_TIME);
    ...
    public void hideNativeSeekBar() {
        if (mSmallMutiSeekbar != null) {
            mSmallMutiSeekbar.setVisibility(View.INVISIBLE);
        ...
        if (mLargeMutiSeekbar != null) {
            mLargeMutiSeekbar.setVisibility(View.INVISIBLE);
    ...
    public void showNativeSeekBar() {
        ...
        if (mLargeSeekbar != null) {
            mLargeSeekbar.setVisibility(View.INVISIBLE);
        }
        if (mSmallMutiSeekbar != null) {
